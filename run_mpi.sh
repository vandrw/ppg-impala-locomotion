...
# Add the option -n after 'mpirun' to increase or lower the number of workers used.
mpirun --mca opal_warn_on_missing_libcuda 0 python -m src.train_mpi -c configs/healthy.yml --run-name healthy_mpi
